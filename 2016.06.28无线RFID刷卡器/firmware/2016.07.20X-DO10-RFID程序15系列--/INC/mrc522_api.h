...
MRC522_API_EXT unsigned char k_con;//记录卡离开时间，防止重刷机制
MRC522_API_EXT volatile unsigned char  kk_con;//记录卡离开时间，防止重刷机制
MRC522_API_EXT volatile unsigned char  sk_con;//记录卡离开时间，防止重刷机制
MRC522_API_EXT volatile unsigned char ccon_flag;//mrc522防冲突全局变量
MRC522_API_EXT volatile unsigned char son_flag;//mrc522防冲突全局变量
MRC522_API_EXT unsigned char con_flag;//mrc522防冲突全局变量
MRC522_API_EXT unsigned char  RC522_rFlag;	//rc522  BUffer已经成功收到数据


MRC522_API_EXT volatile unsigned short rc_blink_read;//mrc522读卡 成功后闪烁信号

#define LED_ON_TIME 100   //信号灯亮时间
#define MAXRLEN 18
#define MAX_K_CON 5		 //记录卡离开时间，防止重刷机制
...
extern void M1_WriteDate(unsigned char rc_au,unsigned char rc_block,unsigned char* rc_dat,unsigned char *sec_key);
extern void M1_ChangeKey(unsigned char c_block);
#endif
