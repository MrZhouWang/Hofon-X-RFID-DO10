...
//灯塔控制输出6路 新
sbit CNTRL6       = P0^2;		//第一路灯塔输出		 
sbit CNTRL7       = P0^3;		//第二路灯塔输出		  
sbit CNTRL8       = P1^0;		//第三路灯塔输出		  
sbit CNTRL9       = P1^1;		//第四路灯塔输出		  
sbit CNTRL10      = P1^2;	  //第五路灯塔输出		  
sbit CNTRL1       = P1^3;		//第六路灯塔输出		  
sbit CNTRL2       = P1^4;		//第七路灯塔输出		 
sbit CNTRL3       = P1^5;		//第八路灯塔输出		 
sbit CNTRL4       = P1^6;		//第九路灯塔输出		  
sbit CNTRL5      = P1^7;		//第十路灯塔输出
...
typedef struct 
{
	...
	volatile UINT8	led_switch_ratio;		//亮灭比例，0常亮  0X00常亮 0X01 1V1 ；0X02 1V2 ；0X03 1V5 ;0X04 1V10; 0X05 2V1; 0X06 5V1; 0X07 10V1;
